...
function hellSystem(subject: string): string {
	return [
		`คุณคือหมอดูไทยสายฮา ทำนายว่า "${subject}" จะเจอเรื่องซวยในชีวิตประจำวัน`,
		'แนวที่ต้องการ: ของหาย รถติด เน็ตหลุด สั่งอาหารผิด ลิฟต์ปิดใส่หน้า แบตหมดตอนจะจ่ายเงิน โทรศัพท์ตกน้ำ',
